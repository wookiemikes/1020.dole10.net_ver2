...
if (isset($_POST['view'])) {
    ...
    while ($row = mysqli_fetch_assoc($viewresults)) {
        ...
        $_SESSION["uad_focal"] = $row["uad_focal"];
        ...
        <div class="sidebar-left">
            <div class="sidebar-left-info">
                ...
                <ul class="side-navigation">
                    ...
                    <li class="active">
                        <a href="../pages/dash-approved-pfo"><i class=" mdi mdi-keyboard-backspace"></i> <span>Return</span></a>
                    </li>
                                ...
                                <div class="card m-b-30 contact">
                                    <div class="card-body">
                                        ...
                                        <table class="table">
                                            <tr>
                                                <td><b>EIN: </b></td>
                                                <td><i><?php echo $_SESSION["uad_ein"] ?></i></td>
                                            </tr>
                                            <tr>
                                                <td><b>APPROVED BY: </b></td>
                                                <td><i><?php echo $_SESSION["uad_focal"] ?></i></td>
                                            </tr>
                                            <tr>
                                                <td><b>DATE APPROVED: </b></td>
                                                <td><i><?php echo $_SESSION["uad_date_approved"] ?></i></td>
                                            </tr>
                                            <tr>
                                                <td><b>INSPECTOR: </b></td>
                                                <td><i><?php echo $_SESSION["uad_inspector"] ?></i></td>
                                            </tr>
                                            <tr>
                                                <td><b>DATE INSPECTED: </b></td>
                                                <td><i><?php echo $_SESSION["uad_date_inspection"] ?></i></td>
                                            </tr>
                                            <tr>
                                                <td colspan="2"><a class="btn btn-block btn-md btn-success" target="_blank" href="<?php echo $_SESSION["uad_req_link"] ?>"><i class="mdi mdi-attachment mr-2"></i><b>REQUIREMENTS</b> </a></td>
                                            </tr>
                                            <tr>
                                                <td colspan="2">
                                                    <form action="pdf.php" method="post">
                                                        <input type="hidden" name="tin" value="<?php echo $_SESSION['id_diff']; ?>" readonly>
                                                         <input type="hidden" name="oat_head" value="<?php echo $_SESSION['oat_head']; ?>">
                                                        <button type="submit" name="print" class="btn btn-md btn-danger btn-block"><i class="mdi mdi-file-pdf mr-2"></i><b>GENERATE PDF</b></button>
                                                    </form>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="2">
                                                    <form action="certificate.php" method="post">
                                                        <input type="hidden" name="oat_head" value="<?php echo $_SESSION['oat_head']; ?>">
                                                        <input type="hidden" name="oat_office_desc" value="<?php echo $_SESSION['oat_office_desc']; ?>">
                                                        <input type="hidden" name="oat_rank" value="<?php echo $_SESSION['oat_rank']; ?>">
                                                        <input type="hidden" name="oat_others" value="<?php echo $_SESSION['oat_others']; ?>">
                                                        <input type="hidden" name="oat_address" value="<?php echo $_SESSION['oat_address']; ?>">
                                                        <input type="hidden" name="oat_email" value="<?php echo $_SESSION['oat_email']; ?>">
                                                        <input type="hidden" name="tin" value="<?php echo $_SESSION['id_diff']; ?>" readonly>
                                                        <button type="submit" name="print" class="btn btn-md btn-info btn-block"><i class="mdi mdi-file-pdf mr-2"></i><b>GENERATE COR</b></button>
                                                    </form>
                                                </td>
                                            </tr>
                                        </table>
                ...
                <div class="modal-content">
                    ...
                    <form action="../pages/dashboard.php" method="post">
                        <div class="modal-body">
                            ...
                            <br>
                            <b>Approved By:</b>
                            <input type="text" class="form-control" placeholder="Name of 1020 Focal" name="focal">
                            <br>
                        ...
                        <div class="modal-footer">
                            ...
                            <input type="hidden" name="pud_tin" value="<?php echo $_SESSION['ud_tin']; ?>">

                            <button type="submit" class="btn btn-success" name="approvedsubmit"><i class="mdi mdi-check-circle mr-2"></i><b>APPROVE</b></button>
                        </div>
                    </form>
                </div>
            </div>
                ...
                <div class="modal-content">
                    ...
                    <form action="../pages/dashboard" method="post">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-danger" name="denies"><i class="mdi mdi-alert-circle mr-2"></i><b>DENY</b></button>
                        </div>
                    </form>
                </div>
            </div>
