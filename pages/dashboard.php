        ...
        <div class="sidebar-left">
            <div class="sidebar-left-info">
                ...
                <ul class="side-navigation">
                    ...
                    <li class="">
                        <a href="../pages/list"><i class="mdi mdi-check-circle"></i> <span>Inspectors (<i>Coming Soon</i>)</span></a>
                    </li>
                    <li class="">
                ...
                <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <form action="../pages/excel.php" method="post">
                    ...
                    <div class="col-lg-12 col-sm-12">
                        <div class="card m-b-30">
                            ...
                            <div class="card-body table-responsive">
                                ...
                                <div class="table-odd">
                                    <table id="pendingTbl" class="table table-bordered">
                                        <thead class="">
                                            <tr>
                                                <th>ID</th>
                    ...
                    <div class="col-lg-12 col-sm-12">
                        <div class="card m-b-30">
                            ...
                            <div class="card-body table-responsive">
                                ...
                                <div class="table-odd">
                                    <table id="approvedTbl" class="table table-bordered">
                                        <thead class="">
                                            <tr>
                                                <th>EIN</th>
                                                <th>ESTABLISHMENT NAME</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            function fetch_data1() {
                var dataTable = $('#pendingTbl').DataTable({
                    "processing": true,
                    "serverSide": true,
                    "columnDefs": [{
                        "orderable": false,
            ...
            function fetch_data2() {
                var dataTable = $('#approvedTbl').DataTable({
                    "processing": true,
                    "serverSide": true,
                    "columnDefs": [{
                        "orderable": false,
                    ...
                    "order": [],
                    "ajax": {
                        url: "../pages/dashboardfetch-approved.php",
                        type: "POST"
                    }
                });
            }
