...
$columns = array('ud_id','ud_est_name','ud_email','ud_contact','ua_status','uad_date_filed','uad_date_approved','id_diff');

$query = "SELECT * FROM `user_details_tbl` WHERE ua_status ='PENDING' ";
