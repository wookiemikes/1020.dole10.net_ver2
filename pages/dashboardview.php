        ...
        <div class="modal fade" id="approve" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form action="../pages/dashboardview-back-a.php" method="post">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-success" name="sendApproveBtn"><i class="mdi mdi-check-circle mr-2"></i><b>APPROVE & SEND EMAIL</b></button>
                        </div>
                    </form>
                </div>
            </div>
                ...
                <div class="modal-content">
                    ...
                    <form action="../pages/dashboardview-back-a.php" method="post">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="exampleFormControlTextarea1"><b>State Remarks:</b></label>
                                <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="remarks2" placeholder="State Here"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-success" name="sendPendingBtn"><i class="mdi mdi-check-circle mr-2"></i><b>SEND EMAIL</b></button>
                        </div>
                    </form>
                </div>
            </div>
