                                        ...
                                        <form class="form mt-5 contact-form" action="../pages/login-pfo-bck" method="POST">
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-12 mt-4">
                                                    <input class="btn btn-primary btn-block" name="loginpfo" type="submit" value="Log In">
                                                </div>
                                            </div>
...
<head>
    ...
    <title>ONLINE ESTABLISHMENT REGISTRATION SYSTEM</title>
                ...
                <div class="row">
                    <div class="col-lg-12 mx-auto col-sm-12">
                        <div class="wrapper-page">
                            <div class="account-pages">
                                <div class="error-500">
                                    <h2>SYSTEM UNAVAILABLE</h2></h2>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-12 text-center error-text">
                                            <h2 class="text-dark">WE ARE UNDERGOING SYSTEM MAINTENANCE!</h2>
                                            <br>
                                        </div>
                                    </div>
                                </div>
